...
namespace Assembler.Behaviours
{
	...
	/// tick (via <see cref="LivePropertyBindingExtensions.BindLive{T,TOwner}(Assembler.Resolving.IValueProvider{T},TOwner,System.Action{T},T)"/>) only for a genuinely non-observable
