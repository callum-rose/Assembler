...
namespace Assembler.Behaviours
{
	...
	/// <see cref="LivePropertyBindingExtensions.BindLive{T,TOwner}(Assembler.Resolving.IValueProvider{T},TOwner,System.Action{T},T)"/>; disposes everything it holds in
	/// <see cref="OnDestroy"/>.
	/// </summary>
