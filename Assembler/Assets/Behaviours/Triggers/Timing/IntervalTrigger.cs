...
namespace Assembler.Behaviours.Triggers.Timing
{
	...
	public class IntervalTrigger : TimingTrigger<IntervalTriggerData>, INeedsGameClock, IAmExecutable
	{
		...
		// The previous life's coroutine was stopped when the shell deactivated; drop the stale handle (so Execute
		// doesn't log a spurious "already running"), then re-arm AutoStart — Unity's once-per-lifetime Start does
		// not re-run on a reused component.
