...
namespace Assembler.Behaviours.Movement
{
	...
	/// <c>Min</c> — the classic Asteroids wrap. Frame-rate independent, so it ignores the clock's delta — but
	/// still pauses with the game.
	/// Properties:
	...
	/// </remarks>
	public class WrapPosition : PerFrameBehaviour<WrapPositionData>
	{
