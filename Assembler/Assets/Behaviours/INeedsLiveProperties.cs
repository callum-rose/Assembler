namespace Assembler.Behaviours
{
	...
	/// <see cref="LivePropertyBindingExtensions.BindLive{T,TOwner}(Assembler.Resolving.IValueProvider{T},TOwner,System.Action{T},T)"/>. The build pipeline injects the shared
