...
namespace Tests.Voxelization
{
	public sealed class YamlRoundTripTests
	{
		...
		public void VModel_ReadRecoversStructure()
		{
			...
			Assert.That(read.TargetHeight, Is.EqualTo(10));
...
";
		...
		public void Manifest_RoundTrips()
		{
			var manifest = new SetManifest
			{
				...
				Assets = new[]
				{
					new ManifestAsset { Id = "villager", Height = 10, Symmetry = "bilateral", Rig = true, Reference = "villager.png" },
					new ManifestAsset { Id = "oak_tree", Height = 50, Symmetry = "none" },
				},
			};
			...
			Assert.That(read.Assets[1].Height, Is.EqualTo(50));
		}
