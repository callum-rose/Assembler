	...
	public static class BehaviourRegistry
	{
		public readonly static IReadOnlyDictionary<string, BehaviourFactory> All =
			new Dictionary<string, BehaviourFactory>
			{
				...
				["vector list fill"] = ListFillInfo<Vector3>.Create,
				...
				["int list fill"] = ListFillInfo<int>.Create,
				...
				["float list fill"] = ListFillInfo<float>.Create,
				...
				["bool list fill"] = ListFillInfo<bool>.Create,
				...
				["string list fill"] = ListFillInfo<string>.Create,
				...
				["colour list fill"] = ListFillInfo<Color>.Create,
