	...
	public static class BehaviourRegistry
	{
		public readonly static IReadOnlyDictionary<string, BehaviourFactory> All =
			new Dictionary<string, BehaviourFactory>
			{
				...
				["mouse button down trigger"] = MouseButtonDownTriggerInfo.Create,
				["mouse button up trigger"] = MouseButtonUpTriggerInfo.Create,
				["mouse button hold trigger"] = MouseButtonHoldTriggerInfo.Create,
