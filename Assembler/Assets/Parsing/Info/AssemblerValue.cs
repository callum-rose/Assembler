...
namespace Assembler.Parsing.Info
{
	...
	public sealed record RuntimeObjectValue(UnityEngine.Object Value) : AssemblerValue;
	...
	public sealed record EntityPropertyRef(ParameterisableEntityId EntityId, EntityProperty Property)
