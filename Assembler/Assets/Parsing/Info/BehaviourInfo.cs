...
namespace Assembler.Parsing.Info
{
	...
	{
		public static BoxColliderInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new BoxColliderInfo(Id, substitutedListeners,
	...
	{
		public static SphereColliderInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new SphereColliderInfo(Id, substitutedListeners,
	...
	{
		public static RigidbodyInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<bool>(v, props?.GetValueOrDefault("UseGravity"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new RigidbodyInfo(Id, substitutedListeners,
	...
	{
		public static VelocityInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<Vector3>(v, props?.GetValueOrDefault("Velocity"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new VelocityInfo(Id, substitutedListeners,
	...
	{
		public static TranslateInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<Vector3>(v, props?.GetValueOrDefault("Displacement"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new TranslateInfo(Id, substitutedListeners,
	...
	{
		public static KeyHoldTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<string>(v, props?.GetValueOrDefault("Key"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new KeyHoldTriggerInfo(Id, substitutedListeners,
	...
	{
		public static KeyDownTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<string>(v, props?.GetValueOrDefault("Key"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new KeyDownTriggerInfo(Id, substitutedListeners,
				Key.Substitute(parameters, allValues));
	}
	...
	{
		public static KeyUpTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<string>(v, props?.GetValueOrDefault("Key"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new KeyUpTriggerInfo(Id, substitutedListeners,
				Key.Substitute(parameters, allValues));
	}

	public record TapTriggerInfo(string Id, IReadOnlyList<BehaviourDescriptor> Listeners) : BehaviourInfo(Id, Listeners)
	{
		public static TapTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static DoubleTapTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static LongPressTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static SwipeTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static DragTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static PinchTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static RotateTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static ConditionInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new ConditionInfo(Id, substitutedListeners,
	...
	{
		public static TimerTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<float>(v, props?.GetValueOrDefault("Delay"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new TimerTriggerInfo(Id, substitutedListeners,
	...
	{
		public static OnStartTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static IntervalTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<float>(v, props?.GetValueOrDefault("Interval"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new IntervalTriggerInfo(Id, substitutedListeners,
	...
	{
		public static EveryFrameTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static CollisionEnterTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
	...
	{
		public static TriggerEnterTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TagsToDetect")));
	...
	{
		public static TriggerExitTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TagsToDetect")));
	...
	{
		public static TriggerStayTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TagsToDetect")));
	...
	{
		public static CollisionExitTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TagsToDetect")));
	...
	{
		public static CollisionStayTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TagsToDetect")));
	...
	{
		public static WhenAllInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
	...
	{
		public static WhenAnyInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.ConvertStringList(props?.GetValueOrDefault("TriggerIds")));
	...
	{
		public static SpawnerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new SpawnerInfo(Id, substitutedListeners,
	...
	{
		public static DestroyInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners);
	...
	{
		public static VariableSetterInfo<T> Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new VariableSetterInfo<T>(Id, substitutedListeners,
	...
	{
		public static SetPositionInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
				Transformer.Wrap<Vector3>(v, props?.GetValueOrDefault("Position"), parameters: p));

		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new SetPositionInfo(Id, substitutedListeners,
	...
	{
		public static CameraInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
		...
		public override BehaviourInfo SubstituteParameters(IReadOnlyList<BehaviourDescriptor> substitutedListeners, IReadOnlyDictionary<string, object> parameters, IReadOnlyList<ValueInfo> allValues) =>
			new CameraInfo(Id, substitutedListeners,
	...
	{
		public static ConditionTriggerInfo Create(string id, IReadOnlyList<BehaviourDescriptor> listeners,
			Dictionary<string, object>? props, IReadOnlyList<ValueInfo> v, IReadOnlyDictionary<string, object>? p) =>
			new(id, listeners,
