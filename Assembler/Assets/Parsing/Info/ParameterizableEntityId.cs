...
namespace Assembler.Parsing.Info
{
	...
	/// whose value is only known when the template is instantiated. This unifies the parameterizable
	...
	/// </remarks>
	public abstract record ParameterizableEntityId(string Id)
	{
		...
		/// </summary>
		public abstract ParameterizableEntityId Resolve(IReadOnlyDictionary<string, AssemblerValue> parameters);
	}

	/// <summary>A fully-known entity id.</summary>
	public sealed record LiteralEntityId(string Id) : ParameterizableEntityId(Id)
	{
		public override string? PendingParameter => null;

		public override ParameterizableEntityId Resolve(IReadOnlyDictionary<string, AssemblerValue> parameters) => this;
	}

	/// <summary>An entity id authored as <c>!parameter &lt;name&gt;</c>, resolved at template instantiation.</summary>
	public sealed record ParameterEntityId(string ParameterId) : ParameterizableEntityId(string.Empty)
	{
		public override string? PendingParameter => ParameterId;

		public override ParameterizableEntityId Resolve(IReadOnlyDictionary<string, AssemblerValue> parameters) =>
