...
namespace Assembler.Generation
{
	...
	{
		public const string SubFolder = "GeneratedGameDescriptors";

		public static string FolderPath => Path.Combine(Application.persistentDataPath, SubFolder);
