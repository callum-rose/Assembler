...
namespace Assembler.AssetGeneration.MeshToVoxel.Editor.Tests
{
    ...
    /// </summary>
    public sealed class ColourPassTests
    {
        ...
        public void Metrics_CountsVoxelsFacesAndColours()
        {
            ...
            VoxelMetrics metrics = VoxelMetrics.Compute(
        ...
        {
            string objPath = Path.Combine(Path.GetTempPath(), "meshtovoxel-pipeline-cube.obj");
            ...
            try
            {
                ...
                StageResult result = Pipeline.Run(objPath, settings);
