...
namespace Assembler.AssetGeneration.MeshToVoxel.Generation
{
    ...
    public sealed class ConfigGeneratorWindow : EditorWindow
    {
        ...
        private const string ModelPref = "Assembler.AssetGeneration.MeshToVoxel.Generation.Model";
        private const string ArtContextPref = "Assembler.AssetGeneration.MeshToVoxel.Generation.ArtContext";
        private const string DescriptionPref = "Assembler.AssetGeneration.MeshToVoxel.Generation.Description";
