...
{
    /// <summary>
    /// Editor-side orchestration for the Mesh to Voxel window: load a mesh from disk, run the engine-free
    ...
    public static class Pipeline
    {
        ...
        /// </summary>
        public static StageResult Run(string meshPath, Settings settings, Action<float, string>? progress = null)
        {
