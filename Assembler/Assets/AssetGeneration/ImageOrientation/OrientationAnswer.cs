...
{
    /// <summary>
    /// What an orientation vision call resolved to — a closed discriminated union over the modes the
    /// logic supports:
    /// <list type="bullet">
    /// <item><see cref="Facing"/> — a compass direction, read from a single image (L/R/U/D + diagonals,
    /// plus T/A for towards/away).</item>
    ...
    /// <item><see cref="Unsure"/> — the model explicitly reported it could not tell.</item>
    /// </list>
    ...
    public abstract record OrientationAnswer
    {
        ...
        public sealed record Unsure : OrientationAnswer;
